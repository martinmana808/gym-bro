    ...
    <section className="flex flex-col gap-2">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="text-sm text-zinc-500 transition hover:text-lime-600"
        >
            ...
            return (
              ...
              >
                <div className="flex items-baseline justify-between gap-3">
                  ...
                  <span className="whitespace-nowrap text-sm tabular-nums text-zinc-600">
...
function SetEditor({
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col justify-end bg-zinc-900/40" onClick={onClose}>
      <div
        className="mx-auto w-full max-w-md rounded-t-3xl border-t border-zinc-200 bg-zinc-50 p-5 pb-[max(1.5rem,env(safe-area-inset-bottom))]"
      ...
      >
        ...
        <button
          ...
          className="mt-4 w-full rounded-2xl bg-lime-400 py-3.5 font-bold text-zinc-950 shadow-lg shadow-lime-500/20 transition hover:bg-lime-300 active:scale-[0.98]"
        >
          Save set
        </button>
      </div>
